...
int main()
{
		...
		matInput(B,r2,c2);
		matDisplay(B,r2,c2);
		C=matAddDC(A,B,max,max);
		matDisplay(C,r1,c2);
		return 0;
}

int **matAddDC(int** mat1,int** mat2,int rows,int columns)
{
		//int i,j;
        ...
        int **c11 = matAddDC(a11,b11, row2,row2);
        int **c12 = matAddDC(a12,b12, row2,row2);
        int **c21 = matAddDC(a21,b21, row2,row2);
        int **c22 = matAddDC(a22,b22, row2,row2);
